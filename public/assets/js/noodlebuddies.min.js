...
var host,ws,NoodleBuddyViewModel,noodleBuddyVM;host=location.origin.replace(/^http/,"ws"),ws=new WebSocket(host),NoodleBuddyViewModel=function(){var d;d=this,this.noodleName=ko.observable(""),this.buddyStatus=ko.observable(""),this.buddyName=ko.observable(""),this.buddyCount=ko.observable(0),this.countText=ko.pureComputed(function(){return 1==d.buddyCount()?"buddy":"buddies"}),this.showPanel=ko.pureComputed(function(){return""!==d.buddyStatus()}),this.panelClass=ko.pureComputed(function(){return""===d.buddyStatus()?"hidden":"panel-"+d.buddyStatus()}),this.message=ko.pureComputed(function(){return""==d.buddyStatus()?"tpl-none":"tpl-"+d.buddyStatus()}),this.buddyCheckTimeout=null},NoodleBuddyViewModel.prototype.getBuddy=function(){var d;this.noodleName().length&&(d={msg_type:"get_buddy",noodle_name:this.noodleName()},ws.send(JSON.stringify(d)))},NoodleBuddyViewModel.prototype.bailOut=function(){var d;d={msg_type:"cancel"},this.clearBuddyCheckTimeout(),ws.send(JSON.stringify(d))},NoodleBuddyViewModel.prototype.setBuddyCheckTimeout=function(){this.buddyCheckTimeout=setTimeout(this.getBuddy.bind(this),5e3)},NoodleBuddyViewModel.prototype.clearBuddyCheckTimeout=function(){this.buddyCheckTimeout&&clearTimeout(this.buddyCheckTimeout)},NoodleBuddyViewModel.prototype.setBuddyName=function(d){this.clearBuddyCheckTimeout(),this.buddyName(d)},noodleBuddyVM=new NoodleBuddyViewModel,ws.onmessage=function(d){var e,o,t,u;e=this,t={waiting:function(){noodleBuddyVM.buddyStatus("waiting")},found_buddy:function(d){noodleBuddyVM.setBuddyName(d.buddy_name),noodleBuddyVM.buddyStatus("found")},lost_buddy:function(){noodleBuddyVM.setBuddyName(""),noodleBuddyVM.buddyStatus("lost"),noodleBuddyVM.setBuddyCheckTimeout()},buddy_count:function(d){noodleBuddyVM.buddyCount(parseInt(d.count,10))},reset:function(){noodleBuddyVM.buddyName(""),noodleBuddyVM.buddyStatus("")}},o=JSON.parse(d.data),(u=t[o.msg_type]||function(){console.log("unsupported msg_type")})(o)},ko.applyBindings(noodleBuddyVM);